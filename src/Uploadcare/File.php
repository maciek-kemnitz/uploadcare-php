...
class File
{
	...
	public function __get($name)
	{
		if ($name == 'data') {
			if (!$this->cached_data) {
				$this->cached_data = (array)$this->api->__preparedRequest(Api::API_TYPE_FILE, Api::REQUEST_TYPE_GET, array('file_id' => $this->file_id));
			}
	...
	{
		return $this->api->__preparedRequest(Api::API_TYPE_STORE, Api::REQUEST_TYPE_POST, array('file_id' => $this->file_id));
	}
	...
	{
		return $this->api->__preparedRequest(Api::API_TYPE_STORE, Api::REQUEST_TYPE_DELETE, array('file_id' => $this->file_id));
	}
